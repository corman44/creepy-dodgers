...
/** @type {string} */
const CACHE_VERSION = '1756604987|7122883701';
/** @type {string} */
const CACHE_PREFIX = 'dodge-creeps2-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'dodge-creeps2.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["dodge-creeps2.html","dodge-creeps2.js","dodge-creeps2.offline.html","dodge-creeps2.icon.png","dodge-creeps2.apple-touch-icon.png","dodge-creeps2.audio.worklet.js","dodge-creeps2.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["dodge-creeps2.wasm","dodge-creeps2.pck"];
